...
class RecTV : MainAPI() {
    ...
    override val mainPage = mainPageOf(
        "${mainUrl}/api/movie/by/filtres/0/created/SAYFA/${swKey}/"  to "Son Eklenen Filmler",
        "${mainUrl}/api/serie/by/filtres/0/created/SAYFA/${swKey}/"  to "Son Eklenen Diziler",
    ...
    override suspend fun getMainPage(page: Int, request: MainPageRequest): HomePageResponse {
        try {
            ...
            Log.d("RECTV", "Error loading main page: ${e.message}")
    ...
    override suspend fun search(query: String): List<SearchResponse> {
        try {
            ...
            Log.d("RECTV", "Error in search: ${e.message}")
            return emptyList()
        }
    }
